...
export class PersondocumentService{
  ...
  get() {
    var postData = {
      request_TYPE: "GET",
      request_URI: setting.commonServicePath+"persondocument",
      request_BODY: ""
    }
  ...
  getAll() {
    var postData = {
      request_TYPE: "GET",
      request_URI: setting.commonServicePath+"persondocument/all",
      request_BODY: ""
    }
    return this._HttpCallServieService_.api(postData);
  }
  ...
  getOne(id) {
    var postData = {
      request_TYPE: "GET",
      request_URI: setting.commonServicePath+"persondocument/" + id,
      request_BODY: ""
    }
    return this._HttpCallServieService_.api(postData);
  }
  ...
  search(data) {
    var postData = {
      request_TYPE: "POST",
      request_URI: setting.commonServicePath+"persondocument/search",
      request_BODY: JSON.stringify(data)
  ...
  searchAll(data) {
    var postData = {
      request_TYPE: "POST",
      request_URI: setting.commonServicePath+"persondocument/search/all",
      request_BODY: JSON.stringify(data)
    }
    return this._HttpCallServieService_.api(postData);
  }
  ...
  advancedSearch(data) {
    var postData = {
      request_TYPE: "POST",
      request_URI: setting.commonServicePath+"persondocument/advancedsearch",
      request_BODY: JSON.stringify(data)
    }
    return this._HttpCallServieService_.api(postData);
  }
  ...
  advancedSearchAll(data) {
    var postData = {
      request_TYPE: "POST",
      request_URI: setting.commonServicePath+"persondocument/advancedsearch/all",
      request_BODY: JSON.stringify(data)
    }
    return this._HttpCallServieService_.api(postData);
  }
